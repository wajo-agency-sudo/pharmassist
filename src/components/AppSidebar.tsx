                ...
                <SidebarMenuItem key={item.title} className="relative group isolate">
                  ...
                  >
                    <Link to={item.url} onClick={handleLinkClick} className="relative">
                      ...
                      {item.urgentCount && (
                        <span className="absolute top-1/2 right-[1px] -translate-y-1/2 bg-red-500 text-white rounded-full px-[2px] py-1 text-xs font-bold whitespace-nowrap z-[9999] shadow-md">
                          {item.urgentCount}
                        </span>
                      )}
                    </Link>
